            ...
            dbc.ModalBody([
                ...
                dbc.Row([
                    dbc.Col([
                        ...
                        html.Small("Actual NAV of this deal", className="text-muted")
                    ], width=4),
                    dbc.Col([
...
def add_deal(n, name, strat, size, irr, hold, vint, segment, sec, geo, deals, config):
    ...
    return deals + [{
        ...
        'segment': segment or 'Seed',  # Portfolio segment for TWR tracking
        'sector': sec or 'Technology',
        'geography': geo or 'Global', 'date_added': datetime.now().isoformat(),
        'is_actual': True  # Mark as actual portfolio deal (real NAV)
    }]
