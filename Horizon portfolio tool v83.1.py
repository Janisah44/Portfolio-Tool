...
def tab_overview(portfolio, pipeline, placeholders, config):
    """Fund Overview — identity, investment mandate, allocation targets, legal limits + live compliance."""
    ...
    top_kpis = html.Div([
        ...
        kpi("Compliance",        compliance_label,     "Mandate restrictions",           compliance_color),
