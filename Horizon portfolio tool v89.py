...
DEFAULT_CONFIG = {
    ...
    "legal_restrictions": [
        {"label": "Single Deal Concentration",    "metric_key": "max_deal_pct",    "limit": 5.0,  "higher_is_bad": True,  "fmt": "%"},
        ...
        {"label": "Single Region Concentration",  "metric_key": "max_region_pct",  "limit": 60.0, "higher_is_bad": True,  "fmt": "%"},
        {"label": "Unfunded / Fund Size",         "metric_key": "unfunded_pct",    "limit": 25.0, "higher_is_bad": True,  "fmt": "%"},
        {"label": "Minimum # Positions",          "metric_key": "num_deals",       "limit": 10.0, "higher_is_bad": False, "fmt": "n"},
        {"label": "Leverage (% NAV)",             "metric_key": "leverage_pct",    "limit": 0.0,  "higher_is_bad": True,  "fmt": "%"},
    ],
    "investment_targets": [
        {"label": "Primary Fund Investments",     "metric_key": "primary_pct",     "limit": 10.0, "higher_is_bad": True,  "fmt": "%"},
        {"label": "Non-Secondary Allocation",     "metric_key": "non_sec_pct",     "limit": 40.0, "higher_is_bad": True,  "fmt": "%"},
        {"label": "Non-NA/Europe Exposure",       "metric_key": "non_naeur_pct",   "limit": 25.0, "higher_is_bad": True,  "fmt": "%"},
    ...
    return html.Div([
        ...
        card([
            ...
            html.Details([
                ...
                html.Pre(
                    "max_deal_pct      — largest single deal as % NAV\n"
                    ...
                    "leverage_pct      — leverage (currently 0, placeholder)\n"
