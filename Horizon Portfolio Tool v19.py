"""
Horizon Fund - Portfolio Tool - INSTITUTIONAL GRADE
...
Run: python Horizon_Fund_Portfolio_Tool.py
...
app.title = "Horizon Fund Portfolio Tool"
server = app.server
...
navbar = dbc.Navbar(
    dbc.Container([
        html.Div([
            ...
            dbc.NavbarBrand("Horizon Fund Portfolio Tool", style={
                'fontSize': '24px',
                'fontWeight': 'bold',
                'fontFamily': C['sans'],
